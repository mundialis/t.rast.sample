...
"""
    ...
    def test_sampling_region_coords(self):
        ...
        content = """start_time|end_time|1|2|3
2001-01-01 00:00:00|2001-04-01 00:00:00|102|104|120
2001-04-01 00:00:00|2001-07-01 00:00:00|202|204|220
2001-07-01 00:00:00|2001-10-01 00:00:00|302|304|320
2001-10-01 00:00:00|2002-01-01 00:00:00|402|404|420
"""
        out = open("out.txt", "r").read()
        self.assertEqual(content, out)
